...
INSERT INTO `schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (1, 'dailyJobTaskService', 'syncTraffic', NULL, '0 0 0 * * *', '每日同步流量', 1, '2020-11-11 10:31:52', '2020-11-25 20:42:00');
INSERT INTO `schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (2, 'dailyJobTaskService', 'cleanDB', NULL, '0 0 0 * * *', '每日清理数据库', 1, '2020-11-11 10:31:52', '2020-11-25 20:42:05');
INSERT INTO `schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (3, 'checkJobTaskService', 'checkJob', NULL, '0 * * * * ?', '检查任务', 1, '2020-11-12 20:35:55', '2020-11-27 10:56:48');
INSERT INTO `schedule`(`id`, `bean_name`, `method_name`, `method_params`, `cron_expression`, `remark`, `job_status`, `created_time`, `update_time`) VALUES (4, 'checkOrderJobTaskService', 'checkOrderJob', NULL, '*/5 * * * * ?', '支付宝主动查单', 1, '2020-12-17 22:30:17', NULL);
